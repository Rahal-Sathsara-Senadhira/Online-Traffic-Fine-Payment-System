...
async function seed() {
  try {
    ...
    const officers = await Officer.bulkCreate([
      { id: uuidv4(), name: 'Sunil Perera', badge_number: 'PC-1001', phone: '0771234567', district: 'Colombo' },
      { id: uuidv4(), name: 'Nimal Silva', badge_number: 'PC-1002', phone: '0772345678', district: 'Gampaha' },
      { id: uuidv4(), name: 'Kamal Fernando', badge_number: 'PC-1003', phone: '0773456789', district: 'Kandy' },
      { id: uuidv4(), name: 'Ruwan Rajapaksa', badge_number: 'PC-1004', phone: '0774567890', district: 'Galle' },
      { id: uuidv4(), name: 'Asanka Bandara', badge_number: 'PC-1005', phone: '0775678901', district: 'Matara' },
      { id: uuidv4(), name: 'Chaminda Herath', badge_number: 'PC-1006', phone: '0776789012', district: 'Kurunegala' },
      { id: uuidv4(), name: 'Lasith Jayasuriya', badge_number: 'PC-1007', phone: '0777890123', district: 'Ratnapura' },
      { id: uuidv4(), name: 'Dinesh Wickrama', badge_number: 'PC-1008', phone: '0778901234', district: 'Colombo' },
    ], { ignoreDuplicates: true });
    console.log(`✓ Seeded ${officers.length} officers.`);

    // ── Fines ─────────────────────────────────────────────────────────────────
    const finesData = [
      { ref: 'TF-2026-100001', catIdx: 0, offIdx: 0, nic: '199012345678', name: 'Kamal Perera', vehicle: 'CAB-1234', location: 'Galle Road, Colombo 3', amount: 2500.00, status: 'issued' },
      ...
      { ref: 'TF-2026-100003', catIdx: 2, offIdx: 2, nic: '198709876543', name: 'Mahesh De Silva', vehicle: 'KY-2222', location: 'Peradeniya Road, Kandy', amount: 7500.00, status: 'issued' },
      ...
      { ref: 'TF-2026-100005', catIdx: 4, offIdx: 0, nic: '199811223344', name: 'Pradeep Liyanage', vehicle: 'CAB-5678', location: 'Baseline Road, Colombo 9', amount: 1500.00, status: 'issued' },
      ...
      { ref: 'TF-2026-100007', catIdx: 6, offIdx: 5, nic: '199710293847', name: 'Dinesh Pathirana', vehicle: 'KU-5555', location: 'Kurunegala Main Street', amount: 1000.00, status: 'issued' },
      ...
      { ref: 'TF-2026-100009', catIdx: 0, offIdx: 7, nic: '200112233445', name: 'Namal Rajapaksa', vehicle: 'CAB-9999', location: 'High Level Road, Colombo 6', amount: 2500.00, status: 'issued' },
      { ref: 'TF-2026-100010', catIdx: 3, offIdx: 2, nic: '199654321098', name: 'Aruna Bandara', vehicle: 'KY-7777', location: 'Katugastota, Kandy', amount: 3000.00, status: 'issued' },
    ];
    ...
    for (const f of finesData) {
      ...
      const fine = await Fine.create({
        ...
        status: f.status,
        issued_at: new Date(),
        paid_at: f.status === 'paid' ? new Date() : null,
      });
    ...
    for (let i = 0; i < paidFines.length; i++) {
      ...
      await Payment.create({
        ...
        method: methods[i % 2],
        status: 'completed',
        transaction_ref: `TXN-2026-${100001 + i}`,
        paid_at: new Date(),
      });
    }
